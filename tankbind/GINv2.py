...
class GraphIsomorphismConv(nn.Module):
    ...
    def message_and_aggregate(self, edge_list, edge_weight, edge_feature, num_node, input):
        #print(f"in function message\n{edge_list.shape=},{edge_weight.shape=},{edge_feature.shape=}{num_node=}{input.shape=}")
    ...
    def forward(self, edge_list, edge_weight, edge_feature, num_node, input):
        ...
        """
        #added by Enzo
        #print(f"{edge_list.shape=},{edge_weight.shape=},{edge_feature.shape=}{num_node=}{input.shape=}")
